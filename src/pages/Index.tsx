...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-slate-50 overflow-x-hidden flex flex-col">
      <LiquidCursor />
      <ScrollHeader />
      <ScrollMagic />
      ...
      <div className="footer-wrapper">
        <footer className="w-full p-0 border-t-2 border-gray-700 flex justify-center bg-gradient-to-br from-gray-50 via-white to-slate-50">
